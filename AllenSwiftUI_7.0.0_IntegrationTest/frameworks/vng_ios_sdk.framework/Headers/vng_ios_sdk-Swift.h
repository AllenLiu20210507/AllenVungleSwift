...
typedef SWIFT_ENUM(NSInteger, BannerSize, closed) {
/// 320x50
  BannerSizeRegular = 0,
/// 300x50
  BannerSizeShort = 1,
...
typedef SWIFT_ENUM(NSInteger, NativeAdOptionsPosition, closed) {
...
/// The bool value to determine whether the ad should start muted or not, if the ad has audio.
...
- (void)bannerAdDidFailToLoad:(VungleBanner * _Nonnull)banner withError:(enum VungleError)withError;
- (void)bannerAdWillPresent:(VungleBanner * _Nonnull)banner;
- (void)bannerAdDidPresent:(VungleBanner * _Nonnull)banner;
- (void)bannerAdDidFailToPresent:(VungleBanner * _Nonnull)banner withError:(enum VungleError)withError;
...
typedef SWIFT_ENUM(NSInteger, VungleError, closed) {
  VungleErrorApiRequestDataTaskFailure = 0,
  VungleErrorNoResponseError = 1,
  VungleErrorStatusCodeNot200Error = 2,
  VungleErrorApiRequestDataCreationFailure = 3,
  VungleErrorDownloadTaskFailure = 4,
  VungleErrorCreateConfigURLRequestError = 5,
  VungleErrorCreateAdsURLRequestError = 6,
  VungleErrorCreateConfigAPIEndpointError = 7,
  VungleErrorAdResponseDataFailError = 8,
  VungleErrorConfigResponseDataFailError = 9,
  VungleErrorInvalidPlacementIdError = 10,
  VungleErrorSdkNotInitializedError = 11,
  VungleErrorInvalidAppIdError = 12,
  VungleErrorSdkCurrentlyInitializingError = 13,
  VungleErrorSdkAlreadyInitializedError = 14,
  VungleErrorAdHasNotBeenLoadedError = 15,
  VungleErrorAdIsLoadingError = 16,
  VungleErrorAdHasFailedError = 17,
  VungleErrorAdIsLoadedError = 18,
  VungleErrorAdHasCompletedError = 19,
  VungleErrorAdInvalidStateError = 20,
  VungleErrorPreloadFailure = 21,
  VungleErrorAssetDownloadPreparationError = 22,
  VungleErrorTemplateDownloadPreparationError = 23,
  VungleErrorAssetURLError = 24,
  VungleErrorAdInvalidBannerView = 25,
  VungleErrorDecodeConfigError = 26,
  VungleErrorDecodeAdError = 27,
  VungleErrorDownloadTemplateError = 28,
  VungleErrorDownloadAssetError = 29,
  VungleErrorBadBidPayloadFormatError = 30,
  VungleErrorRetrieveAdunitFromPayloadError = 31,
  VungleErrorUnzipTemplateError = 32,
  VungleErrorAssetDownloadError = 33,
  VungleErrorAssetDownloadDataRetrieveError = 34,
  VungleErrorWriteAssetToLocalError = 35,
  VungleErrorAssetDownloadDataCreationFailure = 36,
  VungleErrorAssetDownloadTemporaryUrlFailure = 37,
  VungleErrorNativeAdPresentingError = 38,
  VungleErrorIfaConflictError = 39,
  VungleErrorTempError = 40,
};
static NSString * _Nonnull const VungleErrorDomain = @"vng_ios_sdk.VungleError";
...
/// The bool value to determine whether the ad should start muted or not.
@property (nonatomic) BOOL startMuted;
...
- (void)interstitialAdDidFailToLoad:(VungleInterstitial * _Nonnull)interstitial withError:(enum VungleError)withError;
...
- (void)interstitialAdDidFailToPresent:(VungleInterstitial * _Nonnull)interstitial withError:(enum VungleError)withError;
...
///
- (void)registerViewForInteractionWithView:(UIView * _Nonnull)view mediaView:(UIImageView * _Nonnull)mediaView iconImageView:(UIImageView * _Nullable)iconImageView viewController:(UIViewController * _Nullable)viewController;
/// Pass UIViews and UIViewController to prepare and display a Native ad.
/// \param view a container view in which a native ad will be displayed. This view will be clickable. 
///
/// \param mediaView a VungleMediaView to display the ad’s image or video 
...
///
- (void)registerViewForInteractionWithView:(UIView * _Nonnull)view mediaView:(UIImageView * _Nonnull)mediaView iconImageView:(UIImageView * _Nullable)iconImageView viewController:(UIViewController * _Nullable)viewController clickableViews:(NSArray<UIView *> * _Nullable)clickableViews;
...
- (void)nativeAdDidFailToLoad:(VungleNative * _Nonnull)native withError:(enum VungleError)withError;
- (void)nativeAdDidFailToPresent:(VungleNative * _Nonnull)native withError:(enum VungleError)withError;
...
- (void)rewardedAdDidFailToLoad:(VungleRewarded * _Nonnull)rewarded withError:(enum VungleError)withError;
- (void)rewardedAdWillPresent:(VungleRewarded * _Nonnull)rewarded;
- (void)rewardedAdDidPresent:(VungleRewarded * _Nonnull)rewarded;
- (void)rewardedAdDidFailToPresent:(VungleRewarded * _Nonnull)rewarded withError:(enum VungleError)withError;
